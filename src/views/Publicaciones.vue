            ...
            <Model v-bind:title="''" class="table" style="width: 25vw; height: 60vh" >
                ...
                <div class="users">
                    <div class="search">
                        ...
                        <input type="text" v-model="location" placeholder="Localización / Nombre Científico" />
                    </div>
                </div>
                ...
                <div class="users">
                    <div class="search">
                        <font-awesome-icon :icon="['fas', 'location-pin']" />
                        <input type="text" v-model="map" placeholder="Coordenadas" />
                    </div>
                </div>
                ...
                <div class="users">
                    <div class="search" title="El salto de linea es un contacto">
                        ...
                        <textarea type="text" v-model="contact" placeholder="Contacto / Estado de Conservación " />
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            if(this.map == '' || this.desc.length == 0) return this.$root.showNotify('error', 'Necesitas agregar coordenadas');
